...
console.error('DEPRECATED (SideNav.js) - Usar o br-react-utils. [Observar versão do router]')
...
class SideNav extends Component {
  ...
  render() {
    const { sideMenu, sideMenuTitle, sideMenuHeaderBg, avatarImg, avatarTitle, avatarSubTitle,
            isFixed, isMenuOpen, children, sideMenuFooter } = this.props;
